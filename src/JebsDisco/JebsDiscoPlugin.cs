...
public class JebsDiscoPlugin : BaseSpaceWarpPlugin
{
    ...
    [PublicAPI] public static JebsDiscoPlugin Instance { get; set; }

    // AppBar button IDs
    internal const string ToolbarFlightButtonID = "BTN-JebsDiscoFlight";
    internal const string ToolbarOabButtonID = "BTN-JebsDiscoOAB";
    internal const string ToolbarKscButtonID = "BTN-JebsDiscoKSC";
    ...
    public override void OnInitialized()
    {
        ...
        var windowOptions = new WindowOptions
        {
            ...
            WindowId = "JebsDisco_MyFirstWindow",
    ...
    private static void LoadAssemblies()
    {
        ...
        var unityAssembly = Assembly.LoadFrom(Path.Combine(currentFolder, "JebsDisco.Unity.dll"));
